// /account/bots — owner-facing bot + PAT management. Server-rendered
// list of resources owned by the signed-in `Owner`; mutating forms
// are server actions that delegate to the same business logic the
// HTTP API uses.
//
// Per requirement-20260520-0914 F10 (Nagai design system) + the
// /bots → /account/bots namespace move in
// requirement-20260520-1401-sector-bot-roster. Bare /bots now
// redirects to the public sector roster; this page is the personal
// management surface.
